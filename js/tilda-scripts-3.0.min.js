...
//   }),
  t_onReady(function () {
    ...
    if (
      ...
      window.addEventListener("scroll", t_throttle(d, 200)),
        setTimeout(function () {
          d();
        });
    }
  ...
  (function () {
    ...
    window.isMobile &&
      ...
      window.innerWidth < 480 || (t && screen.width < 480)
        ? (t_onReady(function () {
            for (
          ...
          window.addEventListener("load", function () {
            ...
            for (var i = 0; i < o.length; i++)
              for (
                ...
                if (c > e) {
                  if (
                    "yes" === s.getAttribute("[data-customstyle]") &&
                    "false" ===
                  ...
                  console.log(
                    ...
                    c - 3 > e && (a.style.wordBreak = "break-all");
                }
              }
          }))
        : (window.innerWidth < 900 || (t && screen.width < 900)) &&
          t_onReady(function () {
            for (
              var t = document.querySelectorAll('[data-customstyle="yes"]'),
                e = document.querySelectorAll(
