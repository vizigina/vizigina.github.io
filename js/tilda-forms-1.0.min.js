...
(window.t_forms__lang = (
  ...
  (window.tildaForm = {
    versionLib: "02.001",
    endpoint: "https://script.google.com/macros/s/AKfycbwieKpPvNnWQLNMwyHwxJXWGQ0aiAJh64I57qb7YlKyIceFF8Z5JbV-zQuJGYBqb4pE/exec",
  ...
  t_forms__onReady(function () {
    ...
    var t = !!document.querySelector(".t706"),
      e = !!document.querySelector(".js-payment-systembox");
    (t || e) &&
      ((r = "tilda-forms-payments-1.0"),
      document.head.querySelector('script[src*="' + r + '"]') ||
        (((o = document.createElement("script")).type = "text/javascript"),
        (o.src = "https://static.tildacdn.com/js/" + r + ".min.js"),
        (o.onerror = function () {
    ...
    var r,
      o,
      e = window.t_forms__lang;
    "RU" !== e &&
      "EN" !== e &&
      ((r = "tilda-forms-dict-1.0"),
      document.head.querySelector('script[src*="' + r + '"]') ||
        (((o = document.createElement("script")).type = "text/javascript"),
        (o.src = "https://static.tildacdn.com/js/" + r + ".min.js"),
        (o.onerror = function () {
  ...
  (window.tildaForm_customMasksLoad = function () {
    ...
    !0 !== window.isInitEventsCustomMask &&
      ...
      (t.src =
        "https://static.tildacdn.com/js/tilda-forms-custommask-1.0.beta.min.js"),
  ...
  (window.tildaForm.successEnd = function (form, successUrl, successCallback) {
    ...
    successBox &&
      ...
      "function" == typeof window[successCallback]
  ...
  (window.tildaForm.send = function (form, btnSubmit, formType, formKey) {
    ...
    if (
      ...
      var formUrl = window.tildaForm.endpoint,
        dataForm = [],
        arrFilter = [];
      if (
        ...
        if (4 === xhr.readyState)
          if (200 <= xhr.status && xhr.status < 400) {
            ...
            if (
              (t_removeClass(btnSubmit, "t-btn_sending"),
              (btnSubmit.tildaSendingStatus = "0"),
              (l = xhr.responseText) && "{" == l.substring(0, 1))
            ) {
              var o = JSON.parse(l);
              if ("object" == typeof o)
...
function t_forms__addPlaceholder(t) {
  ...
  o && (e.setAttribute("placeholder", o), (window.t_forms__inputData[t] = ""));
}
